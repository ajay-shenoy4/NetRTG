...
file_path = os.path.join(folder_path, "table_data_filtered_100.csv")
...
output_path = os.path.join(folder_path, "highlighted_lineups_sorted_Greater_100_Mins.csv")
...
plt.scatter(
    ...
    color="orange", 
    label="Points ≥ 15 Units from Mean With > 100 Mins Played", 
    edgecolor="black"
)
...
plt.xlabel("OFFRTG")
plt.ylabel("DEFRTG")
plt.title("Scatterplot of OFFRTG vs DEFRTG with Highlighted Points With > 100 Mins Played")
plt.legend()
plt.grid(alpha=0.5)
...
# Save the plot
plot_path = os.path.join(graph_path, "scatterplot_with_mean_and_highlights_annotated_Greater_100_Mins.png")
